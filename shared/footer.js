        ...
        <div class="footer-container">
            <div class="footer-section">
                ...
                <div class="social-links">
                    <a href="https://www.google.com/search?q=Coach+Movers+Long+Island" target="_blank" rel="noopener" aria-label="Google Reviews">
                    ...
                    <a href="https://www.yelp.com/biz/coach-movers-garden-city" target="_blank" rel="noopener" aria-label="Yelp Reviews">
                        <svg viewBox="0 0 24 24" width="20" height="20" fill="white"><path d="M12.14 11.94l4.91 1.6c.17.05.3.16.37.32.07.16.06.33-.02.48l-2.19 3.7c-.09.15-.23.25-.4.28-.17.03-.34-.01-.47-.12l-3.64-2.97c-.22-.18-.27-.5-.12-.74l.82-1.3.02-.03c.21-.33.5-.43.72-.22zm-1.4-6.33l.67 5.13c.03.18-.02.36-.14.49-.12.14-.3.22-.48.22h-4.3c-.18 0-.35-.08-.46-.22-.12-.14-.16-.32-.13-.49l.6-4.3c.03-.17.12-.33.27-.42.14-.1.32-.13.48-.08l3.03.98c.22.07.39.28.46.69zm-.67 10.61l-1.18 4.97c-.04.17-.15.32-.31.4-.16.08-.34.09-.5.02l-4.04-1.72c-.16-.07-.28-.2-.34-.36-.06-.16-.04-.34.05-.48l2.4-3.82c.15-.23.44-.33.7-.23l2.82.93c.23.07.38.19.4.29zm2.27-2.39l3.64-3.52c.13-.13.31-.18.48-.16.18.03.33.13.42.28l2.27 3.88c.09.15.11.33.05.49-.06.16-.18.29-.34.35l-5.01 1.77c-.27.09-.56-.04-.67-.3l-.65-1.46-.02-.04c-.16-.35-.12-.64.15-.85l-.32-.44zm-4.8-5.7L3.09 6.5c-.15-.07-.27-.2-.32-.37-.05-.17-.02-.35.08-.49l2.72-3.63c.1-.14.26-.22.43-.24.17-.01.34.05.46.17l3.26 3.4c.2.21.2.53 0 .74L8.3 7.52l-.03.02c-.28.27-.54.3-.73.09z"/></svg>
                    </a>
                </div>
            </div>
            <div class="footer-section">
