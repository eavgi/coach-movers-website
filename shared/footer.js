            ...
            <div class="footer-section">
                ...
                <div class="social-links">
                    ...
                    <a href="https://www.yelp.com/biz/coach-movers-garden-city" target="_blank" rel="noopener" aria-label="Yelp Reviews">
                        <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path d="M20.16 12.73l-5.37-1.54a.77.77 0 0 0-.93.97l2.04 5.2a.77.77 0 0 0 1.32.17l3.33-3.66a.77.77 0 0 0-.39-1.14zm-2.13-4.4l-4.5-3.27a.77.77 0 0 0-1.2.55l-.32 5.6a.77.77 0 0 0 1.04.77l4.82-1.54a.77.77 0 0 0 .16-1.11zM9.7 7.39a.77.77 0 0 0-1.32-.17L5.05 11.1a.77.77 0 0 0 .4 1.24l5.44 1.4a.77.77 0 0 0 .93-.97L9.7 7.39zm1.84 7.24l-5.52.86a.77.77 0 0 0-.47 1.22l3.06 4.05a.77.77 0 0 0 1.28-.13l2.46-5.05a.77.77 0 0 0-.81-.95zm-.7-3.4L5.7 9.85a.77.77 0 0 0-.77 1.2l2.26 2.5a.77.77 0 0 0 1.22-.07l2.52-3.96a.77.77 0 0 0-.39-1.29z" fill="#FF1A1A"/>
                        </svg>
                    </a>
                </div>
            </div>
